...
while(True):
    input_1 = input("First input: ")
    input_2 = input("Second input: ")
    koreanhandler = koreanHandler(input_1)
    koreanhandler1 = koreanHandler(input_2)
    input1 = koreanhandler.splitWord()
    input2 = koreanhandler1.splitWord()
    koreandistance = koreanDistance(input1,input2)
    print(koreandistance.distanceWords())